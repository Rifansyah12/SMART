      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="small-box bg-green">
              <!-- end loading -->
              <div class="inner">
                <h3><span id="ADC">-</span> %</h3>

                <p>Deteksi Kadar Alkohol (Sensor MQ-3)</p>
              </div>
              <div class="icon">
          ...
          <div class="small-box bg-red">
              ...
              <div class="inner">
                <h3><span id="bac">-</span> %</h3>
                <p>Deteksi Kadar Amonia (Sensor MQ 137)</p>
              </div>
              <div class="icon">
                <i class="fas fa-water"></i>
              </div>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="color:red;" id="smartnose-uninus/status/<?php echo $row['serial_number']?>">Offline</td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
  ...
  <script>
    ...
    client.on("message", function(topic, payload){
      ...
      function publishServo(){
        ...
        client.publish("smartnose-uninus/12345678/servo", data, {qos:1, return:true});
      }
      ...
      function publishLampu(value){
        ...
        client.publish("smartnose-uninus/12345678/led", data,{qos:1, return:true});
      }
  </script>